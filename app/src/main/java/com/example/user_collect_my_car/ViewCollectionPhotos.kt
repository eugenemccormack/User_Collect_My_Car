...
class ViewCollectionPhotos: AppCompatActivity(), ImageAdapter.OnItemClickListener {
...
/*        mAuth = FirebaseAuth.getInstance()
        ...
        trip.child(collection_id!!).child("collectionPhotos").addListenerForSingleValueEvent(object : ValueEventListener{
...
/*                    val imageList = snapshot.getValue(TripPlanModel::class.java)
                    ...
                    trip.child(collection_id!!).child("collectionPhotos").child(id!!).addListenerForSingleValueEvent(object : ValueEventListener{
                        override fun onDataChange(snapshot: DataSnapshot) {
